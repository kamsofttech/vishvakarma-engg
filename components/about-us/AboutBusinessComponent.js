...
const AboutBusinessComponent = () => {
  return (
    <>
        <div className='network_img_bisuness'>
        <div className='container'>
            <div className='head-block text-white '>
            <h1 className='netwoerk_business_text'>Authorised dealer for Kirloskar oil Engines (fisheries)</h1>
            </div>
            ...
            <div className='slider_video_box'>
                <img src='/images/about-us/bg-img.jpg'/>
            </div> */}
                {/* <div className='network_img_bisuness'>
                <div className="container">
...
export default AboutBusinessComponent
