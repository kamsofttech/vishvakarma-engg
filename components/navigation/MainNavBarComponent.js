    ...
    <header className="site-header mo-left header">
		<div className={`sticky-header main-bar-wraper navbar-expand-lg ${isFixed}`}>
            <div className="main-bar clearfix">
                    ...
                    <div className='container clearfix mobile-res ' style={{display:isFixed!==null?'none':'flex'}}>
                        <div className="logo-header mostion logo-dark " >
                            
                            <a >
                                <img src='/images/logo/wishwakarma-logo.png' alt="logo"/> 
                        ...
                        <div className='sidelogo-header second-logo' style={{marginLeft:'auto'}}>
                        {/* <a >
                                <img src='/images/logo/Kirloskar-logo.png' alt="logo"/> 
